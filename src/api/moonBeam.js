...
export function getDelegatorRewardStatistic(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getDelegatorRewardStatistic'),
        method: 'post',
        data
    })
}
...
export function getCollatorRewardStatistic(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorRewardStatistic'),
        method: 'post',
        data
    })
}
...
export function getLatestBlockNumber(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getLatestBlockNumber'),
        method: 'get',
        params
    })
}
...
export function getCurrentRoundInfo(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCurrentRoundInfo'),
        method: 'get',
        params
    })
}
...
export function getMaxNominatorsPerCollator(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getMaxNominatorsPerCollator'),
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorCandidatePool(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getRealtimeCollatorCandidatePool'),
        method: 'get',
        params
    })
}
...
export function getSelectedCollators4CurrentRound(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getSelectedCollators4CurrentRound'),
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorState(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getRealtimeCollatorState'),
        method: 'post',
        data
    })
}
...
export function getScheduledExitQueue(params) {
    return request({
        url: formatUrl4Moonbeam('​/moonriver-analysis​/getScheduledExitQueue'),
        method: 'get',
        params
    })
}
...
export function getMaxCollatorsPerRound(params) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getMaxCollatorsPerRound'),
        method: 'get',
        params
    })
}
...
export function getNominatorReward(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getNominatorReward'),
        method: 'post',
        data
    })
}
...
export function getCollatorReward(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorReward'),
        method: 'post',
        data
    })
}
...
export function getCollatorProducedBlocks(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorProducedBlocks'),
        method: 'post',
        data
    })
}
...
export function getCollatorTotalReward(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorTotalReward'),
        method: 'post',
        data
    })
}
...
export function atStake(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/atStake'),
        method: 'post',
        data
    })
}
...
export function getCollatorActionHistory(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorActionHistory'),
        method: 'post',
        data
    })
}
...
export function getCollatorRewardHistory(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getCollatorRewardHistory'),
        method: 'post',
        data
    })
}
...
export function getDelegatorActionHistory(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getDelegatorActionHistory'),
        method: 'post',
        data
    })
}
...
export function getDelegatorRewardHistory(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-analysis/getDelegatorRewardHistory'),
        method: 'post',
        data
    })
}
...
export function getMySubscribe(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-monitor/getMySubscribe'),
        method: 'post',
        data
    })
}
...
export function unsubscribe(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-monitor/unsubscribe'),
        method: 'post',
        data
    })
}
...
export function subscribe(data) {
    return request({
        url: formatUrl4Moonbeam('/moonriver-monitor/subscribe'),
        method: 'post',
        data
    })
}
