...
function formatUrl4Bifrost(url) {
    return utils.formatUrl(window.BIFROST_STAKING_API || '/bifrost-staking', url);
}

//get reward statistic of delegator
export function getDelegatorRewardStatistic(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getDelegatorRewardStatistic'),
        method: 'post',
        data
    })
}
...
export function getCollatorRewardStatistic(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorRewardStatistic'),
        method: 'post',
        data
    })
}
...
export function getLatestBlockNumber(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getLatestBlockNumber'),
        method: 'get',
        params
    })
}
...
export function getCurrentRoundInfo(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCurrentRoundInfo'),
        method: 'get',
        params
    })
}
...
export function getMaxNominatorsPerCollator(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getMaxNominatorsPerCollator'),
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorCandidatePool(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getRealtimeCollatorCandidatePool'),
        method: 'get',
        params
    })
}
...
export function getSelectedCollators4CurrentRound(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getSelectedCollators4CurrentRound'),
        method: 'get',
        params
    })
}
...
export function getRealtimeCollatorState(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getRealtimeCollatorState'),
        method: 'post',
        data
    })
}
...
export function getScheduledExitQueue(params) {
    return request({
        url: formatUrl4Bifrost('​/staking-analysis​/getScheduledExitQueue'),
        method: 'get',
        params
    })
}
...
export function getMaxCollatorsPerRound(params) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getMaxCollatorsPerRound'),
        method: 'get',
        params
    })
}
...
export function getNominatorReward(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getNominatorReward'),
        method: 'post',
        data
    })
}
...
export function getCollatorReward(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorReward'),
        method: 'post',
        data
    })
}
...
export function getCollatorProducedBlocks(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorProducedBlocks'),
        method: 'post',
        data
    })
}
...
export function getCollatorTotalReward(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorTotalReward'),
        method: 'post',
        data
    })
}
...
export function atStake(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/atStake'),
        method: 'post',
        data
    })
}
...
export function getCollatorActionHistory(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorActionHistory'),
        method: 'post',
        data
    })
}
...
export function getCollatorRewardHistory(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getCollatorRewardHistory'),
        method: 'post',
        data
    })
}
...
export function getDelegatorActionHistory(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getDelegatorActionHistory'),
        method: 'post',
        data
    })
}
...
export function getDelegatorRewardHistory(data) {
    return request({
        url: formatUrl4Bifrost('/staking-analysis/getDelegatorRewardHistory'),
        method: 'post',
        data
    })
}
...
export function getMySubscribe(data) {
    return request({
        url: formatUrl4Bifrost('/staking-monitor/getMySubscribe'),
        method: 'post',
        data
    })
}
...
export function unsubscribe(data) {
    return request({
        url: formatUrl4Bifrost('/staking-monitor/unsubscribe'),
        method: 'post',
        data
    })
}
...
export function subscribe(data) {
    return request({
        url: formatUrl4Bifrost('/staking-monitor/subscribe'),
        method: 'post',
        data
    })
}
